// import { APICreateFamilyResponse, FamilyMemberDTO, FamilyTree, FamilyTreeDAOV2, FormField, MappedFamilyMember } from "types";
...
// export function formatOutgoingValues(v: FamilyTreeDAOV2, stepsInStore: { [name: string]: FormField[] }, userId: number, treeId?: number): FamilyTreeDAOV2 {
...
//     return acc;
//   }, {});
// // @ts-ignore: this function, and probably this entire file will be gone soon
...
// }
// export function cleanUpValuesPrefixes(indicator: string, valuesObject: FamilyTreeDAOV2): FamilyMemberDTO {
