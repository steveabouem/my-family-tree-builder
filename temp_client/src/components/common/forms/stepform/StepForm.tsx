...
const StepForm = <V,>({ sx, handleNext, handlePrev, handleSave, duplicateBottomActions }: StepFormProps<V>) => {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: '1rem', position: 'relative', ...sx }}>
