...
export const FieldSectionsStepsGenerator = () => {
  const [collapsed, setCollapsed] = useState<{ [key: string]: boolean }>({ 0: true, 1: true });
...
export default FieldSectionsStepsGenerator;