...
import { User, ChangePasswordValues, APILoginResponse, LoginRequestPayload, APIEndpointResponse } from "types";

export const baseUrl = process.env.REACT_APP_BASE_URL_DEV;

const login = async (values: LoginRequestPayload): Promise<APIEndpointResponse<APILoginResponse>> => {
