...
import { orientationEnum } from 'pages/tree/create/genealogy/definitions';
...
const entitreeSettings = {
  ...
  orientation: orientationEnum.vertical, // "vertical" to see parents top and children bottom, "horizontal" to see parents left and
  ...
  sourceTargetSpacing: 120, // the "vertical" spacing between nodes in vertical orientation, horizontal otherwise
  targetsAccessor: 'children', // the prop used as the array of children ids
};
const { Top, Bottom, Left, Right } = Position;
const generateReactFlowLayout = (tree: any, rootId: any, direction = 'TB') => {
  ...
  entitreeEdges.forEach((edge: any) => {
    console.log('THIS IS AN EDHGE, ', edge);
...
export default generateReactFlowLayout;