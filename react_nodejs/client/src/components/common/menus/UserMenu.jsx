            ...
            </Box>
            {
                user ? (
                    <>
                        ...
                        <Box className="user-menu-link"><Trans>notifications</Trans><Box className="exp-num">2</Box></Box>
                        <Box className="user-menu-link"><Trans>settings</Trans></Box>
                        <Box className="user-menu-link red hover">Logout</Box>
                    </>
                ) : (
                    <Box className="user-menu-link hover green"><Trans>login</Trans></Box>
                )
            }
        </StyledUserMenu>
    ) : null;
