...
const createUser = async (userData: any): Promise<ServiceResponseWithPayload<APIRegistrationResponse | null>> => {
...
const getUserByEmail = async (email: string): Promise<ServiceResponseWithPayload<User | null>> => {
...
const updateUser = async (id: number, updateData: any): Promise<User | null> => {
  try {
...
const updatePassword = async (passwordData: any): Promise<User | null> => {
  try {
